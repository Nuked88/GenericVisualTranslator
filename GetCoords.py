...
#https://stackoverflow.com/a/62467936/3476027
pygame.init()
...
texto=font.render('press "z" to define one corner and again to define the rectangle, it will give you the coords to insert in the config.yaml', True, white, blue)
while not done:
...
print (F"X: {n[0]}")
print (F"Y: {n[1]}")
print (F"extensionOfX: {m[0]}")
print (F"extensionOfY: {m[1]}")

...
## :memo:Requirements
For its operation it is necessary to install the following libraries

Sistema Operativi testati : **Windows 10/11**
...
| **tts_enabled**                     | `True` \| `False`                                    | If enabled, GVT will use windows text to speak the translated phrase.                                                                                                                                                                                                               |             |
...
- Set the dialog progress key if desired, otherwise leave it at `None`. **Note:** Leave to None if your game have a heavy anti-cheat system that not allow anythink except you to press the keys of the keyboard
